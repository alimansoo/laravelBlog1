            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">ثبت نام</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row mt-lg-n10 mt-md-n11 mt-n10">
                <div class="col-xl-5 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}" style="text-align: end">
                                @csrf
                                ...
                                <label for="name" class="col-md-4 col-form-label text-md-end">فامیل </label>
                                <div class="mb-3">
                                    <input id="fname" type="text" class="form-control @error('name') is-invalid @enderror" name="lname" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                ...
                                <label for="name" class="col-md-4 col-form-label text-md-end">ایمیل </label>
                                <div class="mb-3">
                                ...
                                <label for="name" class="col-md-4 col-form-label text-md-end">رمز عبور </label>
                                <div class="mb-3">
                                ...
                                <label for="name" class="col-md-4 col-form-label text-md-end">تکرار رمز </label>
                        ...
                        <p class="text-sm mt-3 mb-0">حساب کاربری دارید؟ <a href="{{ route('login') }}" class="text-dark font-weight-bolder">ورود </a></p>
                        </form>
                    </div>
                </div>
            </div>
