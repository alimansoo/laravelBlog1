<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret bg-white m-2" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/admin/" target="_blank">
            ...
            <span class="me-1 font-weight-bold">{{ auth()->user()->fname.' '.auth()->user()->lname }}</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse px-0 w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link @if($sidebar=='dashboard') active @endif" href="/admin/">
            ...
            <li class="nav-item">
                <a class="nav-link @if($sidebar=='users') active @endif" href="/admin/users">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link @if($sidebar=='articles') active @endif" href="/admin/articles">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text me-1">بلاگ ها</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if($sidebar=='categories') active @endif" href="/admin/categories/" >
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link @if($sidebar=='tags') active @endif" href="/admin/tags">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text me-1">نشانه ها</span>
                </a>
            </li>
{{--            <li class="nav-item">--}}
