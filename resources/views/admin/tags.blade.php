        ...
        <div class="row my-4">
            <div class="col-12">
                <div class="card mb-4">
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">نام نشانه </th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">ادرس نشانه </th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="http://127.0.0.1:8000/assets/img/tag.png" class="avatar avatar-sm me-3" alt="user1">
                                                </div>
                                        ...
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">
                                                <a href="/tag/{{ $tag->slug }}" target="_blank">{{ $tag->title }}</a>
                                            </p>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">
                    ...
                    <div class="d-flex justify-content-center">{{ $tags->withQueryString()->links() }}</div>
                </div>
            </div>
        </div>
    </div>
